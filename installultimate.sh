...
EOF
    ...
    cat >> /usr/local/bin/vps-verify << 'VEOF_BODY'
...
chk_sysctl net.ipv4.tcp_moderate_rcvbuf eq 1               "moderate_rcvbuf = 1"
...
[Unit]
Description=VPS Post-boot Verify v6.1
